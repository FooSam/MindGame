...
[![Version](https://img.shields.io/badge/Version-1.00.01.06-brightgreen.svg)]()
...
## 🍉 休閒遊戲模組 — 水果切切樂 (Fruit Master) 🆕

> 全新加入的**舒壓休閒遊戲**，提供三種截然不同的切水果玩法，搭配 **ASMR 音效**、**7 大水果植物解剖切面**與**動態果汁特調系統**，讓玩家在輕鬆愉悅的氛圍中盡情揮刀！

| 模式 | 圖示 | 核心玩法 |
| :--- | :---: | :--- |
| **💓 心跳果刃戰** | 🍓🍌🍉 | 滑動切割飛越螢幕的水果，炸彈飛過請勿切！60 秒限時衝擊最高分，水果各有植物解剖幾何切面，雙半塊向外噴射旋轉飛散。 |
| **💣 避雷狂刀客** | 💣🔥⚡ | 閃電模式！螢幕瘋狂炸彈轟炸，在爆炸的縫隙中精準切水果，手殘必閃電！ |
| **🍹 切片工坊** | 🥕🍓🍌 | **ASMR 節奏切片體驗**！食材在輸送帶上匀速通過，長按螢幕高速連切（每 115ms 下刀一次），遇到金屬砧板及時鬆手停刀。進度滿後進入 **1.8 秒全螢幕榨汁機旋轉攪拌流體動畫**，依切入食材種類與比例動態特調並呈現一杯專屬特調果汁（含專屬中文命名、漸層色澤、風味評語與配方成份卡）。 |

### 水果切面技術亮點
- 🍌 **香蕉**：彎月弧形斜截面，奶油白果肉 + 中心三稜星狀果核 (Tri-radial core)
- 🍉 **西瓜**：深綠斑紋厚皮、白綠內瓤、鮮紅果肉 + 水滴狀高光黑瓜籽
- 🍓 **草莓**：倒心形 V 截面、放射狀白色血管脈紋 + 5 瓣星形綠萼
- 🥝 **奇異果**：棕毛外皮、翠綠透光果肉 + 黑色芝麻環狀種子輪
- 🐉 **火龍果**：洋紅龍鱗翻翹尖瓣、白玉果肉 + 細小黑芝麻粒
- 🍍 **鳳梨**：金黃菱格厚皮、亮黃旋轉纖維果肉 + 緊實圓形果心
- 🍏 **金蘋果**：金屬高光弧皮、象牙白果肉 + 星芒果核室與深褐種子
...
### v1.00.01.06 (2026-09-16) — 🆕 最新版本
**【休閒遊戲】新增《水果切切樂》舒壓遊戲**
- 🍉 新增全新休閒遊戲「水果切切樂」，包含三大模式：心跳果刃戰、避雷狂刀客、切片工坊。
- 🎨 7 大水果全面重製植物解剖幾何切面（香蕉三稜果核、草莓放射脈紋、奇異果芝麻環等），告別換色西瓜半圓。
- 🔧 修復排行榜頁籤選取指示器永遠停留在第一頁的 BUG，切換頁籤時 UI 同步響應。
- ⚡ 切片工坊升級：支援長按高速連切（每 115ms 下刀），刀刃高度校正不再重疊食材，音效預載 0ms 極速發聲。
- 🍹 切片工坊新增動態特調果汁系統：依切入食材比例動態生成果汁名稱、漸層色、風味描述與配方成份卡。
- 🎬 進度 100% 自動觸發 1.8 秒全螢幕榨汁機旋轉攪拌流體動畫，結算畫面加入防誤觸保護機制。

### v1.00.01.05 (2026-09-16)
- 水果切切樂實機測試 9 大問題全面修復：獨立模式選單重構、60fps 渲染循環定格根治、擬真放大水果、全螢幕拋物線自適應、排行榜得分單位修正。

### v1.00.01.04 (2026-09-15)
- 休閒遊戲選單重構為直立式海報卡片，導入 Gemini 生成直立高畫質海報。
